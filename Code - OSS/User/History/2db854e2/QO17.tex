...
Bla bla secure connections between devices incredibly important. Most small devices nicht mit I/O interfaces ausgestattet oder nicht genug resources for OOB channel bla. Deswegen In Band trust establishment. In this paper we first present relevant information the reader needs, to fully understand the described methods. We then continue by introducing signal cancelation and signal overshadowing as most relevant man in the middle attacks on  
