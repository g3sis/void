...
Using this primitive Hou et al. presented a Help-enabled DH message exchange protocol. Either BS or D publishes (\mathbb{G}, q, g) of the DH scheme if they are not publicly known yet and D calculates $z_D = g^{X_D}$ with $X_D$ being uniformaly at random chosen from $\mathbb{Z}_q$ . 
