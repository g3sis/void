...
## Resolution Inference Rules
  - Unit resolution rule: Given literals l_i (ap or its negation) we have that `(l1 ∨ ... ∨ l_k , m)/(l_1 ∨ ... ∨ l_i−1 ∨ l_i+1 ∨ ... ∨ l_k)` , where l_i and m are the complementary literals
  - Full resolution rule:  '(l_1 ∨ ... ∨ l_k , m_1 ∨ ... ∨ m_n)/(l_1 ∨ ... ∨ l_i−1 ∨ l_i +1 ∨ ... ∨ l_k ∨ m_1 ∨ ... ∨ m_j−1 ∨ m_j+1 ∨ ... ∨ m_n), where l_i and m_j are complementary literals